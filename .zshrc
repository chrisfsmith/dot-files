...
# GIT
#
export GITHUB_USERNAME='chrisfsmith'
...
alias bg='cd $BLOOM_GIT_SANDBOX/webapp_bloomhealth/bloomhealth'
alias bb='cd $BLOOM_GIT_SANDBOX/webapp_bhbo/bhbo'
alias bh='cd $BLOOM_GIT_SANDBOX/bloomhealth'
alias vm='cd $BLOOM_GIT_SANDBOX/provisioning/vagrant/vagrantmanager'


export PATH=~/bin:/usr/local/share/npm/bin:/usr/local/bin:$PATH:/usr/local/sbin:$HOME/.rvm/bin
